...
void SENSOR_ReadRaw(SENSOR_Status_t *data)
{
    if (data != NULL)
    {
        ...
        SENSOR_Data.LEFT2  = (HAL_GPIO_ReadPin(SENSOR_LEFT2_PORT,  SENSOR_LEFT2_PIN)  == GPIO_PIN_RESET) ? 1 : 0;
        SENSOR_Data.LEFT1  = (HAL_GPIO_ReadPin(SENSOR_LEFT1_PORT,  SENSOR_LEFT1_PIN)  == GPIO_PIN_RESET) ? 1 : 0;
        SENSOR_Data.CENTER = (HAL_GPIO_ReadPin(SENSOR_CENTER_PORT, SENSOR_CENTER_PIN) == GPIO_PIN_RESET) ? 1 : 0;
        SENSOR_Data.RIGHT1 = (HAL_GPIO_ReadPin(SENSOR_RIGHT1_PORT, SENSOR_RIGHT1_PIN) == GPIO_PIN_RESET) ? 1 : 0;
        SENSOR_Data.RIGHT2 = (HAL_GPIO_ReadPin(SENSOR_RIGHT2_PORT, SENSOR_RIGHT2_PIN) == GPIO_PIN_RESET) ? 1 : 0;
    }
}
