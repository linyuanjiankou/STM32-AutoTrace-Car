...
typedef enum {
    ...
    MODE_LINEFOLLOWSEQUENCE, /* Line Follow Sequence mode */
    MODE_CURVE,             /* Curve mode with PID parameter switching */
...
/* Update active mode - call in main loop */
void Mode_UpdateActiveMode(void);

/* Update active mode - dispatch to current mode's update function */
void Mode_UpdateCurrent(void);
